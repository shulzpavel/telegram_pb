  ...
  return (
    ...
    >
      <div className="mx-auto flex w-full max-w-3xl flex-col gap-3 px-4 py-10 lg:px-6">
        <div className="h-6 w-44 rounded skeleton-base skeleton-shimmer" aria-hidden="true" />
        <div className="h-4 w-64 rounded skeleton-base skeleton-shimmer" aria-hidden="true" />
